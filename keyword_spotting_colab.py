...
# The directory of the training data on Google Drive
def prepare_local_dataset():
    """Use dataset from Google Drive /MyDrive/AI_data_train"""
...
def convert_wav_to_spectrogram(dataset_dir, output_dir):
    """Convert WAV files to spectrogram images and save them as JPG on Google Drive."""
...
##########################################################################################
# The following allows for running this model training script directly in Colab
#
if __name__ == '__main__':
    ...
    # Toggle for generating spectrograms (set to False if spectrograms are already generated)
